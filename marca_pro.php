...
<body>
 <div id="divCuerpo">
<center> <h1>Buscar marca de producto</h1></center>
<form name="buscar_producto" method="POST" action="ejecuta2.php">
		<center>	<select width="50%" name="marca" size="1" style="width:64%">
