	...
	<form name="modificar_producto" method="POST" action="mod_producto.php">
			...
			<table class="flat-table" border=0 width="95%">
				<tr>
					...
					<td width="30"><input type="text" name="tipo" size="65" value="<?php echo $row['tipo']; ?>" /></td>
				</tr>
				
				<tr>
					<td width="20"><b>Marca</b></td>
					<td width="30"><input type="text" name="marca" size="65" value="<?php echo $row['marca']; ?>" /></td>
				</tr>
				...
				<tr>
					...
					<td width="30"><input type="text" name="caracteristicas" size="85" value="<?php echo $row['caracteristicas']; ?>" /></td>
				</tr>
				
				<tr>
					<td width="20"><b>Precio</b></td>
					<td width="30"><input type="text" name="precio" size="65" value="<?php echo $row['precio']; ?>" /></td>
				</tr>
				
				<tr>
					<td width="20"><b>Precio venta</b></td>
					<td width="30"><input type="text" name="pventa" size="65" value="<?php echo $row['pventa']; ?>" /></td>
				</tr>
				
				<tr>
				
					<td width="20"><b>Existencia</b></td>
					<td width="30"><input type="text" name="existencia" size="65" value="<?php echo $row['existencia']; ?>" /></td>
				</tr>
